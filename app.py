...
- 야간수당은 밤 10시부터 다음날 오전 6시까지의 근로에 대해 적용됩니다.
- 급여일: 매월 10일 
...
※ 셔틀 이용 시 교통비(일 12,000원)에서 셔틀비용 차감 후 지급/오전조의 경우 추가 교통비 지급
셔틀버스는 오전조에 한해 1회 운영중 """,
...
- 오전 근무: **05:45 ~ 14:45**
- 오후 근무: **14:00 ~ 23:00**  
- 스케줄: **3일 근무 → 1일 휴무** 반복 / 팀단위 스케줄 조율 가능

※ 오전 근무 시 05:20까지 인천국제공항 1터미널 검색대 도착 필요합니다.
※ 야간수당은 밤 10시부터 다음날 오전 6시까지의 근로에 대해 적용됩니다.
""",
...
경력 없어도 걱정 마세요 😊 경력단절, 중장년 재취업 환영합니다~!""",
}
...
with tab1:
    ...
    with col_info:
        ...
        <div class="info-card"><strong>🛠 업무</strong><br>아시아나 항공기 기내청소<br>정리정돈 · 출발 전후 정비<br>초보자 가능, 중장년 재취업환영, 경력단절여성 가능 (교육 제공)</div>
...
💬 채용 상담 탭을 이용해 주세요!
        ...
        st.markdown("#### ⚠️ 유의사항")
        st.warning("""
- 오전 근무 시 **05:20 인천공항 1터미널 검색대 도착** 필요
- 모든 항목 필수 입력
- 중복 지원 불가 (연락처 기준)
        """)
    ...
    with col_form:
        ...
        with st.form("apply_form", clear_on_submit=True):
            ...
            with col2:
                gender = st.selectbox("성별 *", ["선택", "남자", "여자"])
            with col3:
