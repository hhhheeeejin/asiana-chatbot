...
COMPANY_KNOWLEDGE = """
[아시아나 에어포트 채용 정보]
- 업무: 항공기 기내 청소, 정리정돈, 소모품 보충 등.
- 급여: 월 평균 289만원 이상 (기본급+식대+교통비 포함, 수당 별도).
- 근무: 05:45~14:45 / 14:00~23:00 (스케줄 근무, 3일 근무 1일 휴무).
- 셔틀: 발산역, 김포공항, 부천 원종사거리 등 주요 거점 04:30 운행.
- 복지: 유니폼 지급, 교통비 지원, 새벽 근무 시 추가 교통비 지급.
"""
